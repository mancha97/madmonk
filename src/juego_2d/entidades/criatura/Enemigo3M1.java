 ...
 * @author lito-
 */
public class Enemigo3M1 extends Enemigo{
    
    public static float vidaActual3;
    ...
    public  static int xJugador, yJugador, xEnemigo3, yEnemigo3;
    private static Rectangle rectanguloE3M1;
    private float rango = 500;
    private double distancia;
    private boolean mood = true;
    public static int orillasx3, orillasy3, orillaswidth3, orillasheight3;
    private ManejadorEntidad entityManager;
    private float vida;
    private int contadorDamage;
    
    
    public Enemigo3M1(Manejador manejador, float x, float y, Jugador jugador1) {
        ...
        orillas.width = 27;
        orillas.height = 32;
        rectanguloE3M1 = orillas;
        orillaswidth3 = orillas.width;
        orillasheight3 = orillas.height;
        
        vidaMaxima = Criatura.DEFAULT_HEALTH_ENEMIGO;
        vidaActual3 = vidaMaxima;
    ...
    private void DibujarVida(Graphics g, int x, int y){
        ...
        g.fillRect(x +5, y - 5 , (int) (vidaActual3), 2);
...
//        }
    ...
    private void DibujarDistancia(Graphics g, int x, int y){
        ...
        xEnemigo3 =  x;
        yEnemigo3 =  y;
        distancia = Utils.CalcularDistancia(xJugador, yJugador, xEnemigo3, yEnemigo3);
    ...
    private void PerseguirJugador(){
        ...
        if(xJugador > xEnemigo3 && yJugador < yEnemigo3){ //diagonal derecha superior
            xMove = speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo3 && yJugador < yEnemigo3){ //diagonal izquierda superior
            xMove = -speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo3 && yJugador == yEnemigo3){ //izquierda 
            xMove = -speed;
        }else if(xJugador == xEnemigo3 && yJugador < yEnemigo3){ //arriba
            yMove = -speed;
        }else if(xJugador > xEnemigo3 && yJugador == yEnemigo3){ //derecha 
            xMove = speed;
        }else if(xJugador == xEnemigo3 && yJugador > yEnemigo3){ //abajo
            yMove = speed;
        }else if(xJugador > xEnemigo3 && yJugador > yEnemigo3){ //diagonal derecha inferior
            xMove = speed;
            yMove = speed;
        }else if(xJugador < xEnemigo3 && yJugador > yEnemigo3){ //diagonal izquierda inferior
            xMove = -speed;
            yMove = speed;
        }
