...
import static juego_2d.entidades.criatura.Jugador.orillasheightJ;
import static juego_2d.entidades.criatura.Jugador.orillaswidthJ;
 ...
 * @author lito-
 */
public class Enemigo1M1 extends Enemigo{
    
    public static float vidaActual1;
    ...
    public  static int xJugador, yJugador, xEnemigo1, yEnemigo1;
    private static Rectangle rectanguloE1M1;
    private float rango = 500;
    private double distancia;
    private boolean mood = true;
    public static int orillasx1, orillasy1, orillaswidth1, orillasheight1;
    private int contadorDamage;

    
    public Enemigo1M1(Manejador manejador, float x, float y, Jugador jugador1) {
        ...
        orillas.width = 27;
        orillas.height = 32;
        rectanguloE1M1 = orillas;
        orillaswidth1 = orillas.width;
        orillasheight1 = orillas.height;
        
        vidaMaxima = Criatura.DEFAULT_HEALTH_ENEMIGO;
        vidaActual1 = vidaMaxima;
    ...
    private void DibujarVida(Graphics g, int x, int y){
        ...
        g.fillRect(x +5, y - 5 , (int) (vidaActual1), 2);
    ...
    private void DibujarDistancia(Graphics g, int x, int y){
        ...
        xEnemigo1 =  x;
        yEnemigo1 =  y;
        distancia = Utils.CalcularDistancia(xJugador, yJugador, xEnemigo1, yEnemigo1);
    ...
    private void PerseguirJugador(){
        ...
        if(xJugador > xEnemigo1 && yJugador < yEnemigo1){ //diagonal derecha superior
            xMove = speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo1 && yJugador < yEnemigo1){ //diagonal izquierda superior
            xMove = -speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo1 && yJugador == yEnemigo1){ //izquierda 
            xMove = -speed;
        }else if(xJugador == xEnemigo1 && yJugador < yEnemigo1){ //arriba
            yMove = -speed;
        }else if(xJugador > xEnemigo1 && yJugador == yEnemigo1){ //derecha 
            xMove = speed;
        }else if(xJugador == xEnemigo1 && yJugador > yEnemigo1){ //abajo
            yMove = speed;
        }else if(xJugador > xEnemigo1 && yJugador > yEnemigo1){ //diagonal derecha inferior
            xMove = speed;
            yMove = speed;
        }else if(xJugador < xEnemigo1 && yJugador > yEnemigo1){ //diagonal izquierda inferior
            xMove = -speed;
            yMove = speed;
        }
