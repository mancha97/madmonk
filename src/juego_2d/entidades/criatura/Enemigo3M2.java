 ...
 * @author lito-
 */
public class Enemigo3M2 extends Enemigo{
    
    public static float vidaActual32;
    private float vidaMaxima;
    private Animacion animDown,animUp, animLeft, animRight;
    private int bandera, c;
    public static boolean posicion1;
    private int posX, posY;
    public  static int xJugador, yJugador, xEnemigo32, yEnemigo32;
    private static Rectangle rectanguloE3M2;
    private float rango = 500;
    private double distancia;
    private boolean mood = true;
    public static int orillasx32, orillasy32, orillaswidth32, orillasheight32;
    private int contadorDamage;

    
    public Enemigo3M2(Manejador manejador, float x, float y, Jugador jugador1) {
        ...
        orillas.width = 22;
        orillas.height = 22;
        rectanguloE3M2 = orillas;
        orillaswidth32 = orillas.width;
        orillasheight32 = orillas.height;
        
        vidaMaxima = Criatura.DEFAULT_HEALTH_ENEMIGO;
        vidaActual32 = vidaMaxima;
    ...
    private void DibujarVida(Graphics g, int x, int y){
        ...
        g.fillRect(x +5, y - 5 , (int) (vidaActual32), 2);
...
//        }
    ...
    private void DibujarDistancia(Graphics g, int x, int y){
        ...
        xEnemigo32 =  x;
        yEnemigo32 =  y;
        distancia = Utils.CalcularDistancia(xJugador, yJugador, xEnemigo32, yEnemigo32);
    ...
    private void PerseguirJugador(){
        ...
        if(xJugador > xEnemigo32 && yJugador < yEnemigo32){ //diagonal derecha superior
            xMove = speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo32 && yJugador < yEnemigo32){ //diagonal izquierda superior
            xMove = -speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo32 && yJugador == yEnemigo32){ //izquierda 
            xMove = -speed;
        }else if(xJugador == xEnemigo32 && yJugador < yEnemigo32){ //arriba
            yMove = -speed;
        }else if(xJugador > xEnemigo32 && yJugador == yEnemigo32){ //derecha 
            xMove = speed;
        }else if(xJugador == xEnemigo32 && yJugador > yEnemigo32){ //abajo
            yMove = speed;
        }else if(xJugador > xEnemigo32 && yJugador > yEnemigo32){ //diagonal derecha inferior
            xMove = speed;
            yMove = speed;
        }else if(xJugador < xEnemigo32 && yJugador > yEnemigo32){ //diagonal izquierda inferior
            xMove = -speed;
            yMove = speed;
        }
