 ...
 * @author lito-
 */
public class Enemigo2M1 extends Enemigo{
    
    public static float vidaActual2;
    private float vidaMaxima;
    private Animacion animDown,animUp, animLeft, animRight;
    private int bandera, c;
    //private Runnable hi= new Damage(); 
    public static boolean posicion2;
    private int posX, posY;
    public  static int xJugador, yJugador, xEnemigo2, yEnemigo2;
    private static Rectangle rectanguloE2M1;
    private float rango = 500;
    private double distancia;
    private boolean mood = true;
    public static int orillasx2, orillasy2, orillaswidth2, orillasheight2;
    private ManejadorEntidad entityManager;
    private int contadorDamage;
    
    public Enemigo2M1(Manejador manejador, float x, float y, Jugador jugador1) {
        ...
        orillas.width = 27;
        orillas.height = 32;
        orillaswidth2 = orillas.width;
        orillasheight2 = orillas.height;
        
        vidaMaxima = Criatura.DEFAULT_HEALTH_ENEMIGO;
        vidaActual2 = vidaMaxima;
...
//        }
    ...
    private void DibujarVida(Graphics g, int x, int y){
        ...
        g.fillRect(x +5, y - 5 , (int) (vidaActual2), 2);
    }
    ...
    private void DibujarDistancia(Graphics g, int x, int y){
        ...
        xEnemigo2 =  x;
        yEnemigo2 =  y;
        distancia = Utils.CalcularDistancia(xJugador, yJugador, xEnemigo2, yEnemigo2);
    ...
    private void PerseguirJugador(){
        ...
        if(xJugador > xEnemigo2 && yJugador < yEnemigo2){ //diagonal derecha superior
            xMove = speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo2 && yJugador < yEnemigo2){ //diagonal izquierda superior
            xMove = -speed;
            yMove = -speed;
        }else if(xJugador < xEnemigo2 && yJugador == yEnemigo2){ //izquierda 
            xMove = -speed;
        }else if(xJugador == xEnemigo2 && yJugador < yEnemigo2){ //arriba
            yMove = -speed;
        }else if(xJugador > xEnemigo2 && yJugador == yEnemigo2){ //derecha 
            xMove = speed;
        }else if(xJugador == xEnemigo2 && yJugador > yEnemigo2){ //abajo
            yMove = speed;
        }else if(xJugador > xEnemigo2 && yJugador > yEnemigo2){ //diagonal derecha inferior
            xMove = speed;
            yMove = speed;
        }else if(xJugador < xEnemigo2 && yJugador > yEnemigo2){ //diagonal izquierda inferior
            xMove = -speed;
            yMove = speed;
        }
