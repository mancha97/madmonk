 ...
 * @author raalv
 */
public class Cristal3 extends StaticEntity{
    private Animacion cristal3;
    public Cristal3(Manejador manejador, float x, float y) {
        super(manejador, x, y, 48, 94);
        cristal3 = new Animacion(180, Efectos.cristal3);
    }
    ...
    private BufferedImage getCurrentAnimationFrame(){
        return cristal3.getCurrentFrame();
    }
}
